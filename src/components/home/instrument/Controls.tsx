...
function SalarySlider() {
  ...
  return (
    <div className="flex flex-col gap-[0.6rem] wide:max-w-[540px] wide:min-w-[280px] wide:flex-[1_1_340px] work:min-w-0 work:flex-[0_0_auto]">
      ...
      <input
        className="m-0 h-[22px] w-full cursor-pointer appearance-none bg-transparent [-webkit-appearance:none] [&::-moz-range-progress]:h-[6px] [&::-moz-range-progress]:rounded-full [&::-moz-range-progress]:bg-primary [&::-moz-range-thumb]:size-[18px] [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-card [&::-moz-range-thumb]:[box-shadow:var(--thumb-shadow)] [&::-moz-range-thumb]:[border:3px_solid_var(--primary)] [&::-moz-range-thumb]:[transition:transform_0.12s_ease,box-shadow_0.12s_ease] [&::-moz-range-track]:h-[6px] [&::-moz-range-track]:rounded-full [&::-moz-range-track]:[background:var(--slider-track)] [&::-webkit-slider-runnable-track]:h-[6px] [&::-webkit-slider-runnable-track]:rounded-full [&::-webkit-slider-runnable-track]:[background:linear-gradient(90deg,var(--primary)_0_var(--fill,30%),var(--slider-track)_var(--fill,30%)_100%)] [&::-webkit-slider-thumb]:mt-[-6px] [&::-webkit-slider-thumb]:size-[18px] [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-card [&::-webkit-slider-thumb]:[box-shadow:var(--thumb-shadow)] [&::-webkit-slider-thumb]:[-webkit-appearance:none] [&::-webkit-slider-thumb]:[border:3px_solid_var(--primary)] [&::-webkit-slider-thumb]:[transition:transform_0.12s_ease,box-shadow_0.12s_ease] [&:active::-moz-range-thumb]:transform-[scale(1.06)] [&:active::-moz-range-thumb]:[box-shadow:var(--thumb-shadow-active)] [&:active::-webkit-slider-thumb]:transform-[scale(1.06)] [&:active::-webkit-slider-thumb]:[box-shadow:var(--thumb-shadow-active)] [&:hover:not(:active)::-moz-range-thumb]:transform-[scale(1.14)] [&:hover:not(:active)::-webkit-slider-thumb]:transform-[scale(1.14)]"
        type="range"
        min={MIN_SALARY}
        max={MAX_SALARY}
        step={SALARY_STEP}
...
const TAILOR_CHIP =
  "group rounded-[9px] border border-dashed border-primary/40 px-[0.7rem] py-[0.5rem] text-left leading-[1.2] [transition:border-color_0.15s,background_0.15s,color_0.15s] hover:border-primary hover:bg-accent-wash aria-pressed:border-solid aria-pressed:border-primary aria-pressed:bg-accent-wash";
