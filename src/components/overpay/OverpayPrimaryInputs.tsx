...
export function OverpayPrimaryInputs({
  ...
  return (
    <Panel>
      <PanelHeader caption="Overpayment inputs" />
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          ...
          {totalBalance > 0 ? (
            <>
              ...
              <p id="lump-sum-max" className="text-xs text-muted-foreground">
                Max: <Figure>{currencyFormatter.format(totalBalance)}</Figure>
              </p>
            </>
          ) : (
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <Label
              htmlFor="overpayment-slider"
              className="text-xs font-semibold tracking-wider text-muted-foreground uppercase"
            >
              Monthly overpayment
            </Label>
            <Figure className="text-sm font-semibold text-cta">
